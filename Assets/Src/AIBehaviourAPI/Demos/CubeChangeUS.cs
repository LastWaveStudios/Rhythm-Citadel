...
namespace AIBehaviourAPI.Demos
{
    public class CubeChangeUS : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            UtilityPerception pressRPerception = new UtilityPerception("press R perception", () => UnityEngine.Input.GetKey(KeyCode.R)? 1.0f : 0.0f);
            UtilityPerception pressYPerception = new UtilityPerception("press Y perception", () => UnityEngine.Input.GetKey(KeyCode.Y)? 1.0f : 0.0f);
            ...
            DecisionFactor timerDecisionFactor = new DecisionFactor("timer decision factor", new Line(0.0f, _maxTime - 1.5f), timerPerception);

            FusionFactorSum fusionFactor = new FusionFactorSum("fusion factor", new ANodeUS[] { rDecisionFactor, yDecisionFactor, timerDecisionFactor });
