...
public class Path
{
    ...
    public List<TileBase> GeneratePath(GameObject pathToLook, Tilemap tilemap) // por ahora esta como parametro, si usamos el singelton tendr� que cogerlo directamente
    {
